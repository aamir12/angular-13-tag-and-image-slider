import { Component, ElementRef, ViewChild, AfterViewInit, OnInit, Output, EventEmitter, Input, ViewChildren, QueryList, HostListener, SimpleChanges, OnChanges } from '@angular/core';
